  ...
  const panelContent = (
    <>
      ...
      <View style={styles.header}>
        ...
        <Pressable onPress={closeDropdown} style={styles.closeBtn} hitSlop={8}>
            ...
            <Pressable
              style={[
                styles.option,
                {
                  ...
                  borderColor: active ? `${theme.colors.primary}66` : 'transparent',
                },
              ]}
              onPress={() => {
                onSelect(item);
    ...
    <>
      ...
      <Pressable
        style={[
          styles.trigger,
          {
            backgroundColor: open ? theme.colors.surfaceAlt : theme.colors.surface,
            borderColor: open || value ? theme.colors.primary : theme.colors.border,
          },
        ]}
        onPress={() => {
          setSearch(value);
      ...
      >
        ...
        <View
          style={[
            styles.triggerIconBadge,
            {
              backgroundColor: open ? `${theme.colors.primary}22` : theme.colors.surfaceAlt,
            },
          ]}
        >
          <Ionicons name="chevron-down" size={16} color={open ? theme.colors.primary : theme.colors.textMuted} />
        </View>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  closeBtn: {
    ...
    width: 28,
    boxShadow: '0px 4px 10px rgba(220, 38, 38, 0.28)',
  },
  searchWrap: {
    alignItems: 'center',
    borderRadius: 12,
